...
const char* ssh_host = "192.168.0.192"; // Replace with your SSH server address
const char* ssh_user = "kali"; // Replace with your SSH username
const char* ssh_password = "k41i1inux"; // Replace with your SSH password
